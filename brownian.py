...
d_var5 = D(5, mean_delta_r_2)
d_var6 = D(5, mean_delta_r_2 + standard_dev_r_2)
d_var4 = D(5, mean_delta_r_2 - standard_dev_r_2)
...
kb_constant = kB(d_var5, f(.0000032), 296.25)
kb_constant2 = kB(d_var6, f(.0000032), 296.25)
kb_constant3 = kB(d_var4, f(.0000032), 296.25)
print kb_constant
print kb_constant2
print kb_constant3
...
for i in range(len(x_values)):
    if i > 1:
        delta_x_val.append(cal_x_values[i] - cal_x_values[i-2])
        delta_y_val.append(cal_y_values[i] - cal_y_values[i-2])
...
d_var10 = D(10, mean_delta_r_2)
d_var11 = D(10, mean_delta_r_2 + standard_dev_r_2)
d_var9 = D(10, mean_delta_r_2 - standard_dev_r_2)
...
for i in range(len(x_values)):
    if i > 2:
        delta_x_val.append(cal_x_values[i] - cal_x_values[i-3])
        delta_y_val.append(cal_y_values[i] - cal_y_values[i-3])
...
d_var15 = D(15, mean_delta_r_2)
d_var16 = D(15, mean_delta_r_2 + standard_dev_r_2)
d_var14 = D(15, mean_delta_r_2 - standard_dev_r_2)
...
kb_constant = kB(d_var15, f(.0000032), 296.25)
kb_constant2 = kB(d_var16, f(.0000032), 296.25)
kb_constant3 = kB(d_var14, f(.0000032), 296.25)
print kb_constant
print kb_constant2
print kb_constant3
...
for i in range(len(x_values)):
    if i > 3:
        delta_x_val.append(cal_x_values[i] - cal_x_values[i-4])
        delta_y_val.append(cal_y_values[i] - cal_y_values[i-4])
...
d_var20 = D(20, mean_delta_r_2)
d_var21 = D(20, mean_delta_r_2 + standard_dev_r_2)
d_var19 = D(20, mean_delta_r_2 - standard_dev_r_2)
...
print d_var20
kb_constant = kB(d_var20, f(.0000032), 296.25)
kb_constant2 = kB(d_var21, f(.0000032), 296.25)
kb_constant3 = kB(d_var19, f(.0000032), 296.25)
print kb_constant
print kb_constant2
print kb_constant3
...
d_var25 = D(25, mean_delta_r_2)
d_var26 = D(25, mean_delta_r_2 + standard_dev_r_2)
d_var24 = D(25, mean_delta_r_2 - standard_dev_r_2)
...
kb_constant = kB(d_var25, f(.0000032), 296.25)
kb_constant2 = kB(d_var26, f(.0000032), 296.25)
kb_constant3 = kB(d_var24, f(.0000032), 296.25)
print kb_constant
print kb_constant2
print kb_constant3
